...
describe('SettingsSchema', () => {
    describe('getSettingsSchema', () => {
        ...
        it('should have plan nested properties', () => {
            expect(getSettingsSchema().general?.properties?.plan?.properties?.directory).toBeDefined();
            expect(getSettingsSchema().general?.properties?.plan?.properties?.directory
                .type).toBe('string');
        });
        ...
        it('should have enableNotifications setting in schema', () => {
            const setting = getSettingsSchema().general.properties.enableNotifications;
