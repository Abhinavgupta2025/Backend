...
(function (Command) {
    ...
    Command["SHOW_SHELL_INPUT_UNFOCUS_WARNING"] = "shellInput.unfocusWarning";
    // App Controls
    ...
    Command["EXPAND_PASTE"] = "app.expandPaste";
...
export const commandDescriptions = {
    ...
    [Command.CYCLE_APPROVAL_MODE]: 'Cycle through approval modes: default (prompt), auto_edit (auto-approve edits), and plan (read-only). Plan mode is skipped when the agent is busy.',
