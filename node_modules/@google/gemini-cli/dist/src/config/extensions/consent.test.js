...
import { requestConsentNonInteractive, requestConsentInteractive, maybeRequestConsentOrFail, INSTALL_WARNING_MESSAGE, SKILLS_WARNING_MESSAGE, } from './consent.js';
...
describe('consent', () => {
    ...
    describe('maybeRequestConsentOrFail', () => {
        ...
        it('should throw an error if consent is denied', async () => {
            ...
            await expect(maybeRequestConsentOrFail(baseConfig, requestConsent, false, undefined)).rejects.toThrow('Installation cancelled for "test-ext".');
        });
        describe('consent string generation', () => {
            ...
            it('should include warning when hooks are present', async () => {
                ...
                expect(requestConsent).toHaveBeenCalledWith(expect.stringContaining('⚠️  This extension contains Hooks which can automatically execute commands.'));
            });
            ...
            it('should show a warning if the skill directory cannot be read', async () => {
                ...
                expect(requestConsent).toHaveBeenCalledWith(expect.stringContaining(`    (Source: ${skill.location}) ${chalk.red('⚠️ (Could not count items in directory)')}`));
            });
        });
    });
