...
import { ExtensionUninstallEvent, ExtensionDisableEvent, ExtensionEnableEvent, KeychainTokenStorage, loadAgentsFromDirectory, loadSkillsFromDir, getRealPath, } from '@google/gemini-cli-core';
...
describe('extension tests', () => {
    ...
    beforeEach(() => {
        ...
        tempHomeDir = getRealPath(fs.mkdtempSync(path.join(os.tmpdir(), 'gemini-cli-test-home-')));
        tempWorkspaceDir = getRealPath(fs.mkdtempSync(path.join(tempHomeDir, 'gemini-cli-test-workspace-')));
    ...
    describe('loadExtensions', () => {
        ...
        it('should load a linked extension correctly', async () => {
            const sourceExtDir = getRealPath(createExtension({
        ...
        describe('id generation', () => {
            ...
            it('should generate id from the original source for linked extensions', async () => {
                ...
                const actualExtensionDir = getRealPath(createExtension({
