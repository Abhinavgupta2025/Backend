...
describe('<Scrollable />', () => {
    ...
    it('renders children', async () => {
        const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(Scrollable, { hasFocus: false, height: 5, children: _jsx(Text, { children: "Hello World" }) }));
        await waitUntilReady();
        expect(lastFrame()).toContain('Hello World');
        unmount();
    });
    it('renders multiple children', async () => {
        const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsxs(Scrollable, { hasFocus: false, height: 5, children: [_jsx(Text, { children: "Line 1" }), _jsx(Text, { children: "Line 2" }), _jsx(Text, { children: "Line 3" })] }));
        await waitUntilReady();
    ...
    it('updates scroll position correctly when scrollBy is called multiple times in the same tick', async () => {
        ...
        unmount();
        const { waitUntilReady: waitUntilReady2, unmount: unmount2 } = renderWithProviders(_jsxs(Scrollable, { hasFocus: true, height: 5, scrollToBottom: true, children: [_jsx(Text, { children: "Line 1" }), _jsx(Text, { children: "Line 2" }), _jsx(Text, { children: "Line 3" }), _jsx(Text, { children: "Line 4" }), _jsx(Text, { children: "Line 5" }), _jsx(Text, { children: "Line 6" }), _jsx(Text, { children: "Line 7" }), _jsx(Text, { children: "Line 8" }), _jsx(Text, { children: "Line 9" }), _jsx(Text, { children: "Line 10" })] }));
    ...
    describe('keypress handling', () => {
        it.each([
            ...
            const { stdin, waitUntilReady, unmount } = renderWithProviders(_jsx(Scrollable, { hasFocus: true, height: 5, children: _jsx(Text, { children: "Content" }) }));
            await waitUntilReady();
