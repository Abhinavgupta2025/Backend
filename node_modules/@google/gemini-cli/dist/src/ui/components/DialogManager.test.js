...
describe('DialogManager', () => {
    ...
    it('renders nothing by default', async () => {
        const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(DialogManager, { ...defaultProps }), { uiState: baseUiState });
    ...
    it.each(testCases)('renders %s when state is %o', async (uiStateOverride, expectedComponent) => {
        const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(DialogManager, { ...defaultProps }), {
            uiState: {
                ...baseUiState,
                ...uiStateOverride,
            },
