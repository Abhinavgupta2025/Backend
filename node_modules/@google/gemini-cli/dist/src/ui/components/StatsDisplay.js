...
const ModelUsageTable = ({ models, quotas, cacheEfficiency, totalCachedTokens, currentModel, pooledRemaining, pooledLimit, pooledResetTime, useGemini3_1, useCustomToolModel, }) => {
    ...
    const modelUsageTitle = isAuto
        ...
        : `Model Usage`;
    return (_jsxs(Box, { flexDirection: "column", marginBottom: 1, children: [_jsx(Box, { alignItems: "flex-end", children: _jsx(Box, { width: nameWidth, children: _jsx(Text, { bold: true, color: theme.text.primary, wrap: "truncate-end", children: modelUsageTitle }) }) }), isAuto &&
                showQuotaColumn &&
...
export const StatsDisplay = ({ duration, title, quotas, footer, selectedAuthType, userEmail, tier, currentModel, quotaStats, }) => {
    ...
    const renderFooter = () => {
        ...
        return _jsx(ThemedGradient, { bold: true, children: footer });
    };
