...
import { MessageBusType, Scheduler, ROOT_SCHEDULER_ID, CoreToolCallStatus, } from '@google/gemini-cli-core';
...
describe('useToolScheduler', () => {
    ...
    it('initializes with empty tool calls', () => {
        const { result } = renderHook(() => useToolScheduler(vi.fn().mockResolvedValue(undefined), mockConfig, () => undefined));
