...
describe('loggers', () => {
    ...
    describe('logModelRouting', () => {
        ...
        it('should log the event to Clearcut and OTEL, and record metrics', () => {
            const event = new ModelRoutingEvent('gemini-pro', 'default', 100, 'test-reason', false, undefined, ApprovalMode.DEFAULT);
        ...
        it('should log the event with numerical routing fields', () => {
            const event = new ModelRoutingEvent('gemini-pro', 'NumericalClassifier (Strict)', 150, '[Score: 90 / Threshold: 80] reasoning', false, undefined, ApprovalMode.DEFAULT, true, '80');
            logModelRouting(mockConfig, event);
            expect(ClearcutLogger.prototype.logModelRoutingEvent).toHaveBeenCalledWith(event);
            expect(mockLogger.emit).toHaveBeenCalledWith({
    ...
    describe('logHookCall', () => {
        ...
        it('should log hook call event to Clearcut and OTEL', () => {
            const event = new HookCallEvent('before-tool', HookType.Command, '/path/to/script.sh', { arg: 'val' }, 150, true, { out: 'res' }, 0);
