...
describe('ToolExecutor', () => {
    ...
    it('should report PID updates for shell tools', async () => {
        ...
        const testPid = 12345;
        vi.mocked(coreToolHookTriggers.executeToolWithHooks).mockImplementation(async (_inv, _name, _sig, _tool, _liveCb, _shellCfg, setPidCallback, _config, _originalRequestName) => {
