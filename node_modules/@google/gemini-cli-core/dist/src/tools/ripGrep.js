...
import { formatGrepResults } from './grep-utils.js';
...
class GrepToolInvocation extends BaseToolInvocation {
    ...
    async performRipgrepSearch(options) {
        const { pattern, path, basePath, include, exclude_pattern, case_sensitive, fixed_strings, context, after, before, no_ignore, maxMatches, max_matches_per_file, } = options;
...
export class RipGrepTool extends BaseDeclarativeTool {
    ...
    constructor(config, messageBus) {
        super(RipGrepTool.Name, 'SearchText', RIP_GREP_DEFINITION.base.description, Kind.Search, RIP_GREP_DEFINITION.base.parametersJsonSchema, messageBus, true, // isOutputMarkdown
        false);
        this.config = config;
