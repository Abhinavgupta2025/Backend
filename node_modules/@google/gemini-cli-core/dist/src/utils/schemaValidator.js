...
export class SchemaValidator {
    ...
    static validate(schema, data) {
        ...
        try {
            ...
            // This matches LenientJsonSchemaValidator behavior in mcp-client.ts.
            debugLogger.warn(`Failed to compile schema (${
            // eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion
            schema?.['$schema'] ?? '<no $schema>'}): ${error instanceof Error ? error.message : String(error)}. ` +
    ...
    static validateSchema(schema) {
        ...
        try {
            ...
            // Skip validation rather than blocking tool usage.
            debugLogger.warn(`Failed to validate schema (${
            // eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion
            schema?.['$schema'] ?? '<no $schema>'}): ${error instanceof Error ? error.message : String(error)}. ` +
